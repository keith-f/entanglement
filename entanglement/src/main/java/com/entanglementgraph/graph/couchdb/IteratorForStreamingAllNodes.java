...
public class IteratorForStreamingAllNodes<C extends Content> implements Iterable<Node<C>> {
  ...
  public IteratorForStreamingAllNodes(CouchDbConnector db, NodeDAO nodeDao) {
    this.db = db;
    this.nodeDao = nodeDao;
    this.typeName = null;
  }

  public IteratorForStreamingAllNodes(CouchDbConnector db, NodeDAO nodeDao, String typeName) {
    this.db = db;
    this.nodeDao = nodeDao;
