 ...
 */
public class GraphIteratorException extends Exception {
  ...
  public GraphIteratorException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
