...
/**
 * A Restlet implementation that returns a raw JSON document for the specified edge type/name.
 *
...
public class EdgeTypeNameRestlet extends Restlet {
  ...
  public EdgeTypeNameRestlet(EntanglementRuntime runtime, GraphConnection conn) {
  ...
  public void handle(Request request, Response response) {
    try {
      ...
      BasicDBObject doc = conn.getEdgeDao().getByName(type, name);
