...
import com.entanglementgraph.revlog.commands.DeleteNode;
    ...
    extends AbstractLogItemPlayer
{
  ...
  {
    return DeleteNode.class.getSimpleName();
  }
  ...
  {
    try {
      DeleteNode op = (DeleteNode) item.getOp();
      nodeDao.delete(op.getNodeKeyset());
    } catch (Exception e) {
