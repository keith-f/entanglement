...
/**
 * A renderer that can be used to draw pie charts for <code>PieChartNode</code> instances.
 *
 * @author Keith Flanagan
 */
public class PieChartRenderer implements CustomCellRenderer<PieChartNode> {
  ...
  @Override
  public void renderCellContentToCanvas(mxCellState state, PieChartNode value,
...
//    System.out.println("Components: "+centralContent.getComponents().length);
  ...
  @Override
  public JComponent renderCellContent(PieChartNode value) {
    if (chartPanel != null) {
      return chartPanel;
    }
...
//  chartPanel.setPreferredSize(new java.awt.Dimension(500, 270));
  ...
  public JFreeChart createChart(PieChartNode value) {
