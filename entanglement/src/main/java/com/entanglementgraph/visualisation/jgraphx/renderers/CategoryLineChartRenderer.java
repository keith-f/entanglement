...
/**
 * A renderer that can be used to draw line charts for <code>CategoryChartNode</code> instances.
 *
 * @author Keith Flanagan
 */
public class CategoryLineChartRenderer implements CustomCellRenderer<CategoryChartNode> {
  private static final Logger logger = Logger.getLogger(CategoryLineChartRenderer.class.getSimpleName());
  ...
  @Override
  public void renderCellContentToCanvas(mxCellState state, CategoryChartNode value,
...
//    System.out.println("Components: "+centralContent.getComponents().length);
  ...
  @Override
  public JComponent renderCellContent(CategoryChartNode value) {
    if (chartPanel != null) {
      return chartPanel;
    }
